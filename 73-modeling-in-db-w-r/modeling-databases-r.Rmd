...
```{r}
# Several minutes - Run R/taxi-corrr.R
...
```{r}
# Several minutes - Run R/taxi-histogram.R
...
```{r}
diabetes_l2norm <- read_rds("data/diabetes-std.rds")
```
